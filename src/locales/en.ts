export default {
  ...
  sectionTitle: {
    ...
    expSubtitle: "An overview of my professional and academic background.",

    skillsBadge: "Skills & Tools",
  ...
  footer: {
    ...
    legalText2: "Digitally printed on the web, distributed worldwide.",

export default {
  ...
  sectionTitle: {
    ...
    expSubtitle: "Un aperçu de mon parcours professionnel et académique.",
  ...
  footer: {
    ...
    legalText2: "Imprimé numériquement sur le web, distribué via le réseau mondial.",
